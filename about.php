    ...
    <div class="about">
        <div class="mydata">
		    ...
		    <dl>
    			...
    			<dt>兴趣: <label> 除了互联网，我还热爱电影、音乐、旅游、运动、舞蹈、文学、书法</label></dt>
    			<dt>个人说明: <label>发现自己的无知、狭隘和浅薄，是一件幸运的事</label></dt>
            </dl>
		  ...
		  <dl>
			...
			<dt>个人网站：<label> <a href="http://www.wanghaifeng.net/">http://www.wanghaifeng.net</a></label></dt>
